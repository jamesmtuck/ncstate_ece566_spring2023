...
extern "C" {
  extern int inline_const_arg;
  extern int inline_function_size_limit;
  extern int inline_growth_factor;
  extern int inline_heuristic;
...
static llvm::Statistic nInstrBeforeInline = {"", "nInstrBeforeInline", "number of instructions"};
...
int main(int argc, char **argv) {
    ...
    inline_const_arg = InlineConstArg;
    inline_function_size_limit = InlineFunctionSizeLimit;
    inline_growth_factor = InlineGrowthFactor;
    inline_heuristic = InlineHeuristic;
...
static llvm::Statistic nAllocas = {"", "Allocas", "number of allocas"};
